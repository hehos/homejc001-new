            ...
            <div class="main-media-box">
                <ul class="clearfix">
                    <li class="img-box img-box-l">
                        <a class="img" href=""><img src="../../img/temp-img/xiaoguo-l.jpg?v=0de92df3f6" alt=""/></a>
                        <a class="mask-layer" href=""><i class="myicon-plus"></i></a>
                    </li>
                    <li class="img-box img-box-m">
                        <a class="img" href=""><img src="../../img/temp-img/xiaoguo-m.jpg?v=2fc0c79a1a" alt=""/></a>
                        <a class="mask-layer" href=""><i class="myicon-plus"></i></a>
                    </li>
                    <li class="img-box img-box-s">
                        <a class="img" href=""><img src="../../img/temp-img/xiaoguo-s.jpg?v=2629413b56" alt=""/></a>
                        <a class="mask-layer" href=""><i class="myicon-plus"></i></a>
                    </li>
                    <li class="img-box img-box-s">
                        <a class="img" href=""><img src="../../img/temp-img/xiaoguo-s.jpg?v=2629413b56" alt=""/></a>
