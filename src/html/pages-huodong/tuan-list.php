...
<div class="container">
    ...
    <div class="row">
            ...
            <div class="tuan-list">
                <ul class="list-content">
                    <li href="#" class="list-group-item">
                        <h4 class="list-group-item-title"><span class="myicon-cate-label">建材</span>
                            <a href="">9月13号 成都建材10周年建材万人团购会 全场1折起  副本</a></h4>
                        <p class="list-group-item-text"><strong>活动日期：</strong>2015-09-19 至 2015-09-19</p>
                        <p class="list-group-item-text"><strong>活动地点：</strong>锦江区顺城大街88号(天府广场东侧)银河王朝大酒店北楼5楼</p>
                        <p class="btn-row"><a class="u-btn-link arrow" href="">马上去看看</a></p>
                    </li>
                    <li href="#" class="list-group-item">
                        <h4 class="list-group-item-title"><span class="myicon-cate-label">建材</span>
                            <a href="">9月13号 成都建材10周年建材万人团购会 全场1折起  副本</a></h4>
        ...
        <div class="layout-side">
            ...
            <!--  预约表单  -->
            <div class="yuyue-form margin-b-19">
            ...
            <!--  往期回顾  -->
            <div class="cont-box margin-b-17">
                <div class="title-bar fs2">
                    <h2 class="title">看过本期抵用券的用户还看了</h2>
                </div>
                <div class="cont-block side-tuan-list">
                    <ul class="list-content">
                        <li href="#" class="list-group-item">
                            <h4 class="list-group-item-title">[<em>已结束</em>]9月13号成都建材10周年建材会全</h4>
                            <p class="list-group-item-text">活动日期：2015-09-19 至 2015-09-19</p>
                            <p class="btn-row"><a href="">查看详细信息&nbsp;&gt;</a></p>
                        </li>
                        <li href="#" class="list-group-item">
                            <h4 class="list-group-item-title">[<em>已结束</em>]9月13号成都建材10周年建材会全</h4>
                            <p class="list-group-item-text">活动日期：2015-09-19 至 2015-09-19</p>
