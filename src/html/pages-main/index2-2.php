...
<head lang="en">
    ...
    <link rel="stylesheet" href="/homejc001-new/src/css/pages-main/index2.css"/>
</head>
<body>
...
<div class="container">
    ...
    <div class="row index-360server">
        ...
        <ul class="clearfix">
            ...
            <li class="item">
                <a class="img" href=""><img src="../../img/temp-img/dingzhi1.jpg" alt=""/></a>
            </li>
            ...
            <li class="item">
                <a class="img" href=""><img src="../../img/temp-img/dingzhi2.jpg" alt=""/></a>
            </li>
            <li class="item">
                <a class="img" href=""><img src="../../img/temp-img/dingzhi1.jpg" alt=""/></a>
            </li>
