        ...
        <div class="container">
            <ul class="header-nav nav-base row">
                ...
                <li class="nav-item has-subnav">
                    <a href="http://192.168.0.188/homejc001-new/src/pages/pages-main/xiaoguotu.php">效果图<i class="icon-angle-up"></i><i class="icon-angle-down"></i></a>
                    <ol class="subnav">
                        <li><a href="">家居美图</a></li>
                        <li><a href="">家居美图</a></li>
                        <li><a href="">家居美图</a></li>
                ...
                <li class="nav-item has-subnav">
                    ...
                    <ol class="subnav">
                        <li><a href="">装修日记</a></li>
                        <li><a href="">学装修</a></li>
                        <li><a href="http://192.168.0.188/homejc001-new/src/pages/pages-main/ask.php">装修问答</a></li>
                    </ol>
                </li>
                <li class="nav-item has-subnav has-icon">
                    <a href="http://192.168.0.188/homejc001-new/src/pages/pages-publicity/zx-nav1.php">
                        找装修<i class="icon-angle-up"></i><i class="icon-angle-down"></i><i class="myicon-new"></i></a>
                    <ol class="subnav">
                        <li><a href="http://192.168.0.188/homejc001-new/src/pages/pages-main/decoration-list.php">装修公司</a></li>
                        <li><a href="">设计师</a></li>
                    </ol>
                </li>
                <li class="nav-item has-subnav">
                    ...
                    <ol class="subnav">
                        <li><a href="">家居</a></li>
                        <li><a href="">家具</a></li>
                        <li><a href="http://192.168.0.188/homejc001-new/src/pages/pages-huodong/coupon-list.php">优惠卷</a></li>
                        <li><a href="http://192.168.0.188/homejc001-new/src/pages/pages-huodong/tuan-list.php">团购</a></li>
                        <li><a href="http://192.168.0.188/homejc001-new/src/pages/pages-main/about.php">关于九正</a></li>
                    </ol>
                </li>
            </ul>
