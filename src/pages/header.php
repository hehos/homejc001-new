    ...
    <div class="header-top">
        <div class="container">
            ...
            <div class="header-top-right">
                <ul class="member-in">
                    <li><a href="">服务中心</a></li>
                    <li><a href="http://192.168.0.188/homejc001-new/src/pages/pages-member/index.php">登录</a></li>
                    <li><a href="">注册</a></li>
                </ul>
    ...
    <div class="header-bottom nav-base-wrap">
        <div class="container">
            <ul class="header-nav nav-base row">
                ...
                <li class="nav-item has-subnav has-icon">
                    <a href="http://192.168.0.188/homejc001-new/src/pages/pages-main/decoration-list.php">
