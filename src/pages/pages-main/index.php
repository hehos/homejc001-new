...
<head lang="en">
    ...
    <link rel="stylesheet" href="http://192.168.0.188/homejc001-new/src/css/pages-main/index.css?v=8437de957e"/>
</head>
<body>
            ...
            <div id="carousel-example-generic" class="carousel slide banner-slider" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item carousel-item active">
                        <a href="http://192.168.0.188/homejc001-new/src/pages/pages-merchant/index.php"><img src="../../img/banner1.jpg?v=9efa0de820" alt=""/></a>
                    </div>
                    <div class="item carousel-item">
                        <a href="http://192.168.0.188/homejc001-new/src/pages/pages-merchant/index.php"><img src="../../img/banner2.jpg?v=625610985e" alt=""/></a>
                    </div>
                    <div class="item carousel-item">
                        <a href="http://192.168.0.188/homejc001-new/src/pages/pages-merchant/index.php"><img src="../../img/banner3.jpg?v=12b9f882f0" alt=""/></a>
                    </div>
                </div>
