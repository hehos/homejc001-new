...
function freeZhaoBiao(n){
	...
	try{
        ...
        var reg=/^\?ptag\=(\d|_)+$/;
        var ul=window.location.search;
        if(ptag=='1_4_2_1' &&  reg.test(ul))
        {
            ptag=ul.replace('?ptag=','');
        }
        if(n !=9)
